...
const pages = [
    ...
    {
        name: 'pipeline-timeline-chart',
        entrypoint: 'analytics-tab/global/pipeline-timeline-chart.js',
        output_filename: 'pipeline-timeline-chart.html',
        based_on_template: 'basic-template.html.ejs'
    },
    {
        name: 'stage-timeline-chart',
        entrypoint: 'analytics-tab/global/stage-timeline-chart.js',
        output_filename: 'stage-timeline-chart.html',
        based_on_template: 'basic-template.html.ejs'
    },
    {
        name: 'priority-view-chart',
        entrypoint: 'analytics-tab/global/priority-view-chart.js',
        output_filename: 'priority-view-chart.html',
        based_on_template: 'basic-template.html.ejs'
    },
    {
        name: 'agents-summary-chart',
        entrypoint: 'analytics-tab/global/pipeline-timeline-chart.js',
        output_filename: 'agents-summary-chart.html',
        based_on_template: 'basic-template.html.ejs'
    },
    {
    ...
    return {
        ...
        module: {
            rules: [
                ...
                {
                    test: /\.js$/,
                    exclude: /node_modules(?!\/slim-select)/,
                    use: [
                        {
                            loader: 'babel-loader',
                            options: {
