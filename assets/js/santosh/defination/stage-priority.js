...
class StagePriority {
    ...
    constructor(settings) {
        ...
        console.log('stage-priority constructor settings', settings);
    }
    ...
    draw(data) {
        ...
        const option = {
            ...
            xAxis: [
                {
                    type: 'category',
                    data: data.map(d => d.stage_name + '/' + d.pipeline_name),
                }
            ],
            yAxis: [
                {
    ...
    get_requestParamsPoint(index) {
        ...
        return {stage_name: this.data[index].stage_name, result: this.settings.result};
    }

    getNextGraphName() {
        return 'StagePriorityDetails';
    }
