...
class StageStartupTimeCompare {
    ...
    constructor(settings) {
        ...
        console.log('stage-startup-time-compare.js settings', settings);
    }
    ...
    draw(data, c) {
        ...
        console.log('stage-startup-time-compare.js this.data = ', this.data);

        const info = this.prepareData(this.data);

        const option = {
            title: {
                // text: 'Stage startup time compare for ' + this.settings.selectedPipeline,
            },
            tooltip: {
                trigger: "axis",
                axisPointer: {
...
export default StageStartupTimeCompare;