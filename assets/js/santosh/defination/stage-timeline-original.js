...
class StageTimeline {
    ...
    draw(data) {
        ...
        c.logs('filteredObjects = ', filteredObjects);
...
`;
    ...
    prepareData(data, chartWidth, chartHeight) {
        ...
        c.logs('2.1 stage-timeline groupedResult = ', groupedResult);
        ...
        switch (this.settings.showPipelineCounterResult) {
            ...
            case 'Only Cancelled':
                ...
                footerMessage = "Instances ignored - Cancelled: " + passedPipelineCounters.length + " Failed: " + failedPipelineCounters.length;
                break;
        }
        ...
        c.logs('4 stage-timeline stageNames = ', stageNames);
        ...
        c.logs('5 stage-timeline rawData = ', rawData);
