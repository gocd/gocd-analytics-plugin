 ...
 */
class StagePriorityDetails {
    data = null;

    constructor(settings) {
        this.settings = settings;

        console.log('stage-priority-details constructor settings', settings);
    }
    ...
    draw(data) {
        ...
        const option = {
            title: {
                text: this.data[0].stage_name + ' details'
            },
            tooltip: {
                trigger: "axis",
                axisPointer: {
...
export default StagePriorityDetails;
