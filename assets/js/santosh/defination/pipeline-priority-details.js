 ...
 */
class PipelinePriorityDetails {
    data = null;

    constructor(settings) {
        this.settings = settings;

        console.log('pipeline-priority-details constructor settings', settings);
    }
...
export default PipelinePriorityDetails;
