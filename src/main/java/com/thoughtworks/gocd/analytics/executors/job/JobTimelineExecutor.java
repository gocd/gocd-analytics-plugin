...
public class JobTimelineExecutor extends AbstractSessionFactoryAwareExecutor {

    private final JobDAO jobDAO;

    public JobTimelineExecutor(AnalyticsRequest analyticsRequest, SessionFactory sessionFactory) {
        this(analyticsRequest, new JobDAO(), sessionFactory);
    }

    public JobTimelineExecutor(AnalyticsRequest analyticsRequest, JobDAO jobDAO,
