...
public class PriorityStageDetailsExecutor extends AbstractSessionFactoryAwareExecutor {

    private final StageDAO stageDAO;

    public PriorityStageDetailsExecutor(AnalyticsRequest analyticsRequest, SessionFactory sessionFactory) {
        this(analyticsRequest, new StageDAO(), sessionFactory);
    }

    public PriorityStageDetailsExecutor(AnalyticsRequest analyticsRequest, StageDAO stageDAO,
...
//                return stageDAO.getAllStagesByPipelineNameAndCounter(sqlSession, pipelineName);
                return stageDAO.stageSummaryDetails(sqlSession, stageName, result);
            }
        });
