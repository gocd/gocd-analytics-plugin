...
public class StageDAO {
    ...
    public List<Stage> getAllStagesByPipelineNameAndCounter(SqlSession sqlSession,
        ...
        int limit) {
        return mapper(sqlSession).stageByPipelineNameAndCounter(startDate, endDate, pipelineName,
            result, order, limit);
    }

    public List<Stage> getStageRerunsForAllPipelines(SqlSession sqlSession,
        String startDate, String endDate, String order,
        int limit) {
        return mapper(sqlSession).stageRerunsForAllPipelines(null, startDate, endDate,
            order, limit);
    }

    public List<Stage> getStageReruns(SqlSession sqlSession, String start,
        String end, String pipelineName, String order, int limit) {
    ...
    public List<Stage> getYearlyStageRerunsForPipeline(SqlSession sqlSession, String pipeline,
        ...
        return mapper(sqlSession).yearlyStageRerunsForPipeline(pipeline, start, end);
    }

    public List<Stage> getYearlyStageRerunsForPipelineWithResult(SqlSession sqlSession,
        String pipeline, String start, String end, String result) {
        return mapper(sqlSession).yearlyStageRerunsForPipelineWithResult(pipeline, start, end, result);
    }
